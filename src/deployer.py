...
""")
    ...
    for line in lines:
      ...
      parameter = oline.split("=")[0].rstrip().lstrip()
      parameters.append(parameter)
      
    if "framepublisher.min_poolsize" not in parameters:
      outlines.append("framepublisher.min_poolsize=1\n")
    if "framepublisher.max_poolsize" not in parameters:
      outlines.append("framepublisher.max_poolsize=5\n")
    if "framepublisher.queuesize" not in parameters:
      outlines.append("framepublisher.queuesize=100\n")
